"""
Smart Employee Management System — Leave Workflows State Transition Workflow Processor
...
class LeaveManagementWorkflowProcessor:
    """
    State machine and transition validator for Leave Workflows.
    """
