"""
Smart Enterprise Management System — Leave Management & Encashment Report Exporter & Data Formatter
...
class LeaveManagementReportExporter:
    """
    CSV and formatted data stream compiler for Leave Management & Encashment.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in leave_management'])
