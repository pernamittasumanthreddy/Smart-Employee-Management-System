"""
Smart Enterprise Management System — Leave Management & Encashment Security Guard & Access Enforcement
...
class LeaveManagementSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Leave Management & Encashment.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on leave_management.",
            required_permissions=[requested_action],
