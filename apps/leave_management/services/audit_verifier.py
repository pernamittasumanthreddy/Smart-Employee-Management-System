"""
Smart Enterprise Management System — Leave Management & Encashment Audit Trail Integrity Verifier
...
class LeaveManagementAuditVerifier:
    """
    Cryptographic audit ledger hash-chain validator for Leave Management & Encashment.
    """
    ...
    def verify_event_chain(
        ...
        for idx, event in enumerate(audit_events):
            ...
            payload_str = f"{prev_hash}|{event_id}|{action}|leave_management"
