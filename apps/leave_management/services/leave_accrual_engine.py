"""
Smart Enterprise Management System — Leave Management Domain Engine
...
class LeaveAccrualPolicyEngine:
    ...
    @classmethod
    def calculate_monthly_earned_leave_accrual(
        cls,
        tenure_months: int,
        present_days_in_month: int,
        standard_monthly_days: int = 25
    ) -> Decimal:
        """
    ...
    @classmethod
    def calculate_leave_encashment_value(
        cls,
        emp_id: int,
        leave_type: str,
        opening_bal: Decimal,
        ...
        max_carry_forward: Decimal = Decimal("30.0")
    ) -> LeaveAccrualSummary:
        """
