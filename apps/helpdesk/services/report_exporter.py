"""
Smart Enterprise Management System — IT & HR Service Desk Helpdesk Report Exporter & Data Formatter
...
class HelpdeskReportExporter:
    """
    CSV and formatted data stream compiler for IT & HR Service Desk Helpdesk.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in helpdesk'])
