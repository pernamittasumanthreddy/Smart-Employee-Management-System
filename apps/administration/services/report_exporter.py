"""
Smart Enterprise Management System — System Administration & Security Report Exporter & Data Formatter
...
class AdministrationReportExporter:
    """
    CSV and formatted data stream compiler for System Administration & Security.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in administration'])
