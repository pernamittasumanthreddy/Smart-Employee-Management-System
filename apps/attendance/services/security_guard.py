"""
Smart Enterprise Management System — Attendance & Biometric Timesheets Security Guard & Access Enforcement
...
class AttendanceSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Attendance & Biometric Timesheets.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on attendance.",
            required_permissions=[requested_action],
