"""
Smart Enterprise Management System — Attendance & Biometric Timesheets Report Exporter & Data Formatter
...
class AttendanceReportExporter:
    """
    CSV and formatted data stream compiler for Attendance & Biometric Timesheets.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in attendance'])
