"""
Smart Employee Management System — OKR Goal Progress State Transition Workflow Processor
...
class GoalsWorkflowProcessor:
    """
    State machine and transition validator for OKR Goal Progress.
    """
