"""
Smart Enterprise Management System — Objectives & Key Results (OKR) Report Exporter & Data Formatter
...
class GoalsReportExporter:
    """
    CSV and formatted data stream compiler for Objectives & Key Results (OKR).
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in goals'])
