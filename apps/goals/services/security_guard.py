"""
Smart Enterprise Management System — Objectives & Key Results (OKR) Security Guard & Access Enforcement
...
class GoalsSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Objectives & Key Results (OKR).
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on goals.",
            required_permissions=[requested_action],
