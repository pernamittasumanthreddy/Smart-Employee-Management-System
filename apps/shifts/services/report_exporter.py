"""
Smart Enterprise Management System — Work Shifts & Rostering Optimization Report Exporter & Data Formatter
...
class ShiftsReportExporter:
    """
    CSV and formatted data stream compiler for Work Shifts & Rostering Optimization.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in shifts'])
