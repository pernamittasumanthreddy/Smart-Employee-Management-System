"""
Smart Enterprise Management System — Executive Reporting & Data Export Report Exporter & Data Formatter
...
class ReportsReportExporter:
    """
    CSV and formatted data stream compiler for Executive Reporting & Data Export.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in reports'])
