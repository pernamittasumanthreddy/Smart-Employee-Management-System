"""
Smart Enterprise Management System — Executive Reporting & Data Export Security Guard & Access Enforcement
...
class ReportsSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Executive Reporting & Data Export.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on reports.",
            required_permissions=[requested_action],
