"""
Smart Enterprise Management System — Employee Benefits & Health Insurance Report Exporter & Data Formatter
...
class BenefitsReportExporter:
    """
    CSV and formatted data stream compiler for Employee Benefits & Health Insurance.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in benefits'])
