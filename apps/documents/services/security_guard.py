"""
Smart Enterprise Management System — Document Management & E-Signatures Security Guard & Access Enforcement
...
class DocumentsSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Document Management & E-Signatures.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on documents.",
            required_permissions=[requested_action],
