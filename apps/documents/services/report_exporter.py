"""
Smart Enterprise Management System — Document Management & E-Signatures Report Exporter & Data Formatter
...
class DocumentsReportExporter:
    """
    CSV and formatted data stream compiler for Document Management & E-Signatures.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in documents'])
