"""
Smart Enterprise Management System — Employee 360 & Workforce Records Security Guard & Access Enforcement
...
class EmployeesSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Employee 360 & Workforce Records.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on employees.",
            required_permissions=[requested_action],
