"""
Smart Enterprise Management System — Employee 360 & Workforce Records Report Exporter & Data Formatter
...
class EmployeesReportExporter:
    """
    CSV and formatted data stream compiler for Employee 360 & Workforce Records.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in employees'])
