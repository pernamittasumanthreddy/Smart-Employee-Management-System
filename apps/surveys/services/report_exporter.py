"""
Smart Enterprise Management System — Employee Pulse Surveys & eNPS Report Exporter & Data Formatter
...
class SurveysReportExporter:
    """
    CSV and formatted data stream compiler for Employee Pulse Surveys & eNPS.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in surveys'])
