"""
Smart Enterprise Management System — Employee Pulse Surveys & eNPS Security Guard & Access Enforcement
...
class SurveysSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Employee Pulse Surveys & eNPS.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on surveys.",
            required_permissions=[requested_action],
