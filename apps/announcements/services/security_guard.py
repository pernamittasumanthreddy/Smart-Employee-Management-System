"""
Smart Enterprise Management System — Company Announcements & Bulletins Security Guard & Access Enforcement
...
class AnnouncementsSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Company Announcements & Bulletins.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on announcements.",
            required_permissions=[requested_action],
