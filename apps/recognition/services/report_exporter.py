"""
Smart Enterprise Management System — Employee Recognition & Peer Kudos Report Exporter & Data Formatter
...
class RecognitionReportExporter:
    """
    CSV and formatted data stream compiler for Employee Recognition & Peer Kudos.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in recognition'])
