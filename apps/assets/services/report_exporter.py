"""
Smart Enterprise Management System — IT & Physical Asset Management Report Exporter & Data Formatter
...
class AssetsReportExporter:
    """
    CSV and formatted data stream compiler for IT & Physical Asset Management.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in assets'])
