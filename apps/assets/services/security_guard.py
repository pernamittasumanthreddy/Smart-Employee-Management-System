"""
Smart Enterprise Management System — IT & Physical Asset Management Security Guard & Access Enforcement
...
class AssetsSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for IT & Physical Asset Management.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on assets.",
            required_permissions=[requested_action],
