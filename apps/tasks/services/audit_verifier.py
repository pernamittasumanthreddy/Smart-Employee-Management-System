"""
Smart Enterprise Management System — Agile Task Kanban & Workflow Audit Trail Integrity Verifier
...
class TasksAuditVerifier:
    """
    Cryptographic audit ledger hash-chain validator for Agile Task Kanban & Workflow.
    """
    ...
    def verify_event_chain(
        ...
        for idx, event in enumerate(audit_events):
            ...
            payload_str = f"{prev_hash}|{event_id}|{action}|tasks"
