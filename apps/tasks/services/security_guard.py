"""
Smart Enterprise Management System — Agile Task Kanban & Workflow Security Guard & Access Enforcement
...
class TasksSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Agile Task Kanban & Workflow.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on tasks.",
            required_permissions=[requested_action],
