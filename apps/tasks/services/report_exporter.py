"""
Smart Enterprise Management System — Agile Task Kanban & Workflow Report Exporter & Data Formatter
...
class TasksReportExporter:
    """
    CSV and formatted data stream compiler for Agile Task Kanban & Workflow.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in tasks'])
