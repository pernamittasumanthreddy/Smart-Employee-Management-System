"""
Smart Enterprise Management System — Skills Matrix & Competency Catalog Security Guard & Access Enforcement
...
class SkillsSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Skills Matrix & Competency Catalog.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on skills.",
            required_permissions=[requested_action],
