"""
Smart Enterprise Management System — Expense Claims & Reimbursement Audit Report Exporter & Data Formatter
...
class ExpensesReportExporter:
    """
    CSV and formatted data stream compiler for Expense Claims & Reimbursement Audit.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in expenses'])
