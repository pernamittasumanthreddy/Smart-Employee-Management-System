"""
Smart Enterprise Management System — Expense Claims & Reimbursement Audit Domain Event Dispatcher & Bus
...
class ExpensesEventDispatcher:
    """
    Asynchronous event bus and domain webhook broadcaster for Expense Claims & Reimbursement Audit.
    """
    ...
    def emit_event(
        ...
        envelope = DomainEventEnvelope(
            event_id=f"EVT-EXP-{uuid.uuid4().hex[:8].upper()}",
            event_type=f"expenses.{event_name}",
            module="expenses",
