"""
Smart Enterprise Management System — Smart Workplace & Facility Desk Booking Security Guard & Access Enforcement
...
class WorkplaceSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Smart Workplace & Facility Desk Booking.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on workplace.",
            required_permissions=[requested_action],
