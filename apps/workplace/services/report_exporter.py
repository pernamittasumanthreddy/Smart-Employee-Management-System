"""
Smart Enterprise Management System — Smart Workplace & Facility Desk Booking Report Exporter & Data Formatter
...
class WorkplaceReportExporter:
    """
    CSV and formatted data stream compiler for Smart Workplace & Facility Desk Booking.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in workplace'])
