"""
Smart Enterprise Management System — Payroll Processing & Compensation Report Exporter & Data Formatter
...
class PayrollReportExporter:
    """
    CSV and formatted data stream compiler for Payroll Processing & Compensation.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in payroll'])
