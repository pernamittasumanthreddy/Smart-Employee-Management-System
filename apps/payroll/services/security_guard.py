"""
Smart Enterprise Management System — Payroll Processing & Compensation Security Guard & Access Enforcement
...
class PayrollSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Payroll Processing & Compensation.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on payroll.",
            required_permissions=[requested_action],
