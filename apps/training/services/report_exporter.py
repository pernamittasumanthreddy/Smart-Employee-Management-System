"""
Smart Enterprise Management System — Learning & Development (L&D) Report Exporter & Data Formatter
...
class TrainingReportExporter:
    """
    CSV and formatted data stream compiler for Learning & Development (L&D).
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in training'])
