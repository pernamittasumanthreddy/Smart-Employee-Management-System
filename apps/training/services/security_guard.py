"""
Smart Enterprise Management System — Learning & Development (L&D) Security Guard & Access Enforcement
...
class TrainingSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Learning & Development (L&D).
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on training.",
            required_permissions=[requested_action],
