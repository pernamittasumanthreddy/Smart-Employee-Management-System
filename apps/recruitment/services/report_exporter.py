"""
Smart Enterprise Management System — Recruitment ATS & Talent Acquisition Report Exporter & Data Formatter
...
class RecruitmentReportExporter:
    """
    CSV and formatted data stream compiler for Recruitment ATS & Talent Acquisition.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in recruitment'])
