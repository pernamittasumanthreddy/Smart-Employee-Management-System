"""
Smart Enterprise Management System — Recruitment ATS & Talent Acquisition Security Guard & Access Enforcement
...
class RecruitmentSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Recruitment ATS & Talent Acquisition.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on recruitment.",
            required_permissions=[requested_action],
