"""
Smart Employee Management System — Recruitment Pipeline State Transition Workflow Processor
...
class RecruitmentWorkflowProcessor:
    """
    State machine and transition validator for Recruitment Pipeline.
    """
