"""
Smart Enterprise Management System — Smart AI & Workforce ML Analytics Domain Event Dispatcher & Bus
...
class InsightsEventDispatcher:
    """
    Asynchronous event bus and domain webhook broadcaster for Smart AI & Workforce ML Analytics.
    """
    ...
    def emit_event(
        ...
        envelope = DomainEventEnvelope(
            event_id=f"EVT-INS-{uuid.uuid4().hex[:8].upper()}",
            event_type=f"insights.{event_name}",
            module="insights",
