"""
Smart Enterprise Management System — Smart AI & Workforce ML Analytics Report Exporter & Data Formatter
...
class InsightsReportExporter:
    """
    CSV and formatted data stream compiler for Smart AI & Workforce ML Analytics.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in insights'])
