"""
Smart Enterprise Management System — Smart AI & Workforce ML Analytics Security Guard & Access Enforcement
...
class InsightsSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Smart AI & Workforce ML Analytics.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on insights.",
            required_permissions=[requested_action],
