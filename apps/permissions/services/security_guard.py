"""
Smart Enterprise Management System — Role-Based Access Control (RBAC) Security Guard & Access Enforcement
...
class PermissionsSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Role-Based Access Control (RBAC).
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on permissions.",
            required_permissions=[requested_action],
