"""
Smart Enterprise Management System — Team Workload & Capacity Management Security Guard & Access Enforcement
...
class WorkloadSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Team Workload & Capacity Management.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on workload.",
            required_permissions=[requested_action],
