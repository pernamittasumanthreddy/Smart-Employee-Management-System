"""
Smart Enterprise Management System — Project Management & Resource Allocation Report Exporter & Data Formatter
...
class ProjectsReportExporter:
    """
    CSV and formatted data stream compiler for Project Management & Resource Allocation.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in projects'])
