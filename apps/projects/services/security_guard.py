"""
Smart Enterprise Management System — Project Management & Resource Allocation Security Guard & Access Enforcement
...
class ProjectsSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Project Management & Resource Allocation.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on projects.",
            required_permissions=[requested_action],
