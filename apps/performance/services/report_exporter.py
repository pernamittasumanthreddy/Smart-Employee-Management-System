"""
Smart Enterprise Management System — Performance Appraisal & 9-Box Grid Report Exporter & Data Formatter
...
class PerformanceReportExporter:
    """
    CSV and formatted data stream compiler for Performance Appraisal & 9-Box Grid.
    """
    ...
    def export_dataset_to_csv(
        ...
        if not records:
            writer.writerow(['No records available for export in performance'])
