"""
Smart Enterprise Management System — Performance Appraisal & 9-Box Grid Security Guard & Access Enforcement
...
class PerformanceSecurityGuard:
    """
    Granular permission gatekeeper and authorization barrier for Performance Appraisal & 9-Box Grid.
    """
    ...
    def authorize_action(
        ...
        return SecurityAuthorizationResult(
            is_authorized=False,
            access_level='DENIED',
            reason=f"Role '{user_role}' lacks permission '{requested_action}' on performance.",
            required_permissions=[requested_action],
