"""
Smart Employee Management System — Appraisal Reviews State Transition Workflow Processor
...
class PerformanceWorkflowProcessor:
    """
    State machine and transition validator for Appraisal Reviews.
    """
